...
<body>
  ...
  <div class="content">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <textarea name="details" id="details"  cols="80" rows="10"></textarea>
    ...
    if (isset($_POST['submit'])) {
      ...
      $insert = "insert into nominee(FullName,PartyName,Image,Details,Votes,Status)values('$FullName','$PartyName','$Image','$details',0,'OFF')";
